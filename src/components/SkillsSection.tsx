  ...
  return (
    <section id="skills" className="py-20 bg-secondary/10">
      <div className="container mx-auto px-6">
        <h2 className="heading-cyberpunk font-sinostone text-4xl md:text-5xl text-center mb-16 text-[#11ff58]">
          TECHNICAL SKILLS
        </h2>
        ...
        <div className="space-y-12">
          {Object.entries(skillCategories).map(([category, skills], index) => (
            <div key={category} className="relative">
              ...
              <h3 className="text-[#11ff58] font-sinostone text-2xl tracking-wider mb-6 text-center">
                {category}
              </h3>
